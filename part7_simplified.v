...
assign Wire_549  = ~ ( ( ~ Wire_548  ) & Wire_545  ) ; // Syntax?
assign Wire_545  = ~ ( I  & S  & Wire_544  & Wire_999  ) ;
assign Wire_543  = Wire_544  | ( I  & S  & Wire_999  ) ;
...
assign Wire_102  = ~ ( ( ~ Wire_127  ) & Wire_75  ) ; // Syntax?
assign Wire_75  = ~ ( I  & S  & Wire_43  & Wire_518  ) ;
assign Wire_158  = Wire_43  | ( I  & S  & Wire_518  ) ;
...
assign Wire_516  = ~ ( Wire_514  | Wire_515  ) ; // Syntax?
  // ref component/or4.v
assign Wire_4  = Wire_64  | (~Wire_53)  | Wire_514  | Wire_515  ;
// ref component/or4b.v
assign Wire_514  = FROM_PART21  | FROM_PART22  | FROM_PART20  | ( ~ FROM_PART23  ) ;
  // ref component/nand2.v
assign Wire_515  = ~ ( I  & S  ) ; // Syntax?
...
assign Wire_519  = ~ ( ( ~ Wire_25  ) & Wire_17  ) ; // Syntax?
  // ref component/nand4.v
assign Wire_17  = ~ ( I  & S  & Wire_517  & Wire_407  ) ;
  // ref component/a31o.v
assign Wire_114  = Wire_517  | ( I  & S  & Wire_407  ) ;
...
assign Wire_409  = ( ( Wire_552  | Wire_542  ) & Wire_410  ) ;
  // ref component/or4.v
assign Wire_410  = Wire_436  | (~Wire_552)  | Wire_540  | Wire_541  ;
  // ref component/nor2.v
assign Wire_542  = ~ ( Wire_540  | Wire_541  ) ; // Syntax?
  // ref component/nand2.v
assign Wire_541  = ~ ( I  & S  ) ; // Syntax?
// ref component/or4b.v
...
assign Wire_546  = ( ( Wire_408  | Wire_537  ) & Wire_707  ) ;
  // ref component/nor2.v
assign Wire_537  = ~ ( Wire_550  | Wire_553  ) ; // Syntax?
  // ref component/or4.v
assign Wire_707  = Wire_551  | (~Wire_408)  | Wire_550  | Wire_553  ;
// ref component/or4b.v
assign Wire_550  = FROM_PART21  | FROM_PART23  | FROM_PART20  | ( ~ FROM_PART22  ) ;
  // ref component/nand2.v
assign Wire_553  = ~ ( I  & S  ) ; // Syntax?
...
assign Wire_200  = ( ( Wire_197  | Wire_195  ) & Wire_189  ) ;
  // ref component/nand2b.v
assign Wire_313  = ~ ( ( ~ Wire_197  ) & Wire_195  ) ; // Syntax?
  // ref component/nand4.v
assign Wire_195  = ~ ( I  & S  & Wire_280  & Wire_321  ) ;
  // ref component/a31o.v
assign Wire_189  = Wire_280  | ( I  & S  & Wire_321  ) ;
...
assign Wire_534  = ( ( Wire_482  | Wire_524  ) & Wire_523  ) ;
  // ref component/nand2b.v
assign Wire_520  = ~ ( ( ~ Wire_482  ) & Wire_524  ) ; // Syntax?
  // ref component/nand4.v
assign Wire_524  = ~ ( I  & S  & Wire_511  & Wire_508  ) ;
  // ref component/a31o.v
assign Wire_523  = Wire_511  | ( I  & S  & Wire_508  ) ;
// ref component/and4bb.v
...
assign Wire_381  = ( ( Wire_360  | Wire_345  ) & Wire_433  ) ;
  // ref component/nand2b.v
assign Wire_525  = ~ ( ( ~ Wire_360  ) & Wire_345  ) ; // Syntax?
  // ref component/nand4.v
assign Wire_345  = ~ ( I  & S  & Wire_227  & Wire_377  ) ;
  // ref component/a31o.v
assign Wire_433  = Wire_227  | ( I  & S  & Wire_377  ) ;
// ref component/and4bb.v
...
assign Wire_526  = ( ( Wire_452  | Wire_529  ) & Wire_528  ) ;
  // ref component/nand2b.v
assign Wire_464  = ~ ( ( ~ Wire_452  ) & Wire_529  ) ; // Syntax?
  // ref component/nand4.v
assign Wire_529  = ~ ( I  & S  & Wire_532  & Wire_527  ) ;
  // ref component/a31o.v
assign Wire_528  = Wire_532  | ( I  & S  & Wire_527  ) ;
// ref component/and4bb.v
...
assign Wire_530  = ( ( Wire_454  | Wire_455  ) & Wire_533  ) ;
  // ref component/or4.v
assign Wire_533  = Wire_445  | (~Wire_454)  | Wire_492  | Wire_506  ;
  // ref component/nor2.v
assign Wire_455  = ~ ( Wire_492  | Wire_506  ) ; // Syntax?
// ref component/or4b.v
assign Wire_492  = FROM_PART21  | FROM_PART22  | FROM_PART23  | ( ~ FROM_PART20  ) ;
  // ref component/nand2.v
assign Wire_506  = ~ ( I  & S  ) ; // Syntax?
